              ...
              <section className="space-y-4">
                ...
                <div className="space-y-3">
                  ...
                  <button
                    ...
                    disabled={webLoading || !webQuery}
                    className="w-full py-3 bg-zinc-800 border border-zinc-700 hover:border-zinc-600 text-zinc-300 hover:text-white text-sm font-medium rounded transition-all disabled:opacity-30"
                  >
                  ...
                  <div className="space-y-3">
                    <div className="relative">
                      ...
                      <button 
                        ...
                        disabled={internalLoading || !internalQuery}
